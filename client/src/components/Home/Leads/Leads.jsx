...
export default function Leads() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(UpdateClient(clientId, dataClient));
      setOpenSuccess(true);
      setTimeout(async () => {
        ...
        <Box sx={styleDetails}>
              ...
              <div className="details-input2">
                <div className="input-details">
                  ...
                  name="country" 
                   ...
                   value={dataClient.country || clientLead.country || ""  }
                   onChange={handleChange}
                   />
                </div>
                <div className="input-details">
                  ...
                  <input 
                    ...
                    name="state" 
                     className="lead-input-detail2" 
                     value={dataClient.state || clientLead.state || ""  }
                     onChange={handleChange}
                  />
                </div>
                <div className="input-details">
                  ...
                  <input 
                    type="text"
                    name="municipality" 
                    value={dataClient.municipality || clientLead.municipality || ""  }
                    onChange={handleChange}
                    className="lead-input-detail2" 
                  />
                </div>
            ...
            <div className="details-textarea">
              <div className="details-input2">
                <div className="textarea-details">
                  ...
                  type="text" 
                  name="address" 
                  value={dataClient.address || clientLead.address || ""  }
                  onChange={handleChange}
          ...
          <div className="input-img">
            <div>
              ...
              <Card
                sx={{ minWidth: 400, border: "2px solid #000", height: 150 }}
              >
                <CardContent
                  sx={{
                    display: "flex",
          ...
          <div>
            ...
            <Card
                sx={{ width: 400, border: "2px solid #000", height: 150 }}
              >
                <CardContent
                  sx={{
                    display: "flex",
